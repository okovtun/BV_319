...
4. От ветки 'DynamicTemplated' создать ветку 'DynamicOptimisation' и в ней
   оптимизировать функции для работы с вдмерными массивами через повторное использование кода;
