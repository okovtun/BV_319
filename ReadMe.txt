...
1. С клавиатуры вводится число, и программа вычисляет факториал этого числа.
   Факториал - это произведение ряда чисел от 1 до указанного, например:
	5! = 1*2*3*4*5 = 120;
2. С клавиатуры вводится основание и показатель степени, и программа вычисляет степень числа.
...
4. С клавиатуры вводится число, и программа выводит на экран ряд Фибоначчи, до введенного числа.
