...
TODO:
1. При вводе минимального и максимального случайного числа предусмотреть возможные ошибки;
2. В Solution 'Arrays' добавить проект 'Unique' и в этом проекте заполнить массив из 10 элементов
